...
- `before-off.sh` - **optional** file with bash code that will be run before we down all containers (for clean-up)
- `after-off.sh` - **optional** file with bash code that will be run after we down all containers (for clean-up)
...
- `before-on.sh` - **optional** file with bash code that will be run before upping all containers
- `after-on.sh` - **optional** file with bash code that will be run after upping all containers
